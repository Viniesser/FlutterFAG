...
class _JokenpohPageState extends State<JokenpohPage> {
  // Apenas alterna entre tela 1 e tela 2
  ...
  Widget _buildImageCircle({required String imagePath, required double size, bool canTap = false}) {
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
          children: [
            _buildImageCircle(imagePath: "assets/images/pedra.png", size: 80.0, canTap: true),
            _buildImageCircle(imagePath: "assets/images/papel.png", size: 80.0, canTap: true),
            _buildImageCircle(imagePath: "assets/images/tesoura.png", size: 80.0, canTap: true),
          ],
        ),
  ...
  Widget _buildResultScreen() {
    return Column(
      ...
      children: [
        Column(
          children: [
            _buildImageCircle(imagePath: "assets/images/tesoura.png", size: 160.0), // Imagem fixa
        ...
        Column(
          children: [
            _buildImageCircle(imagePath: "assets/images/pedra.png", size: 160.0), // Imagem fixa
            const SizedBox(height: 12.0),
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.05), spreadRadius: 2, blurRadius: 5, offset: const Offset(0, 3))],
              ),
              child: Padding(
                padding: const EdgeInsets.all(15.0),
                child: Image.asset("assets/images/icons8-vitória-48.png", fit: BoxFit.contain), // Ícone fixo
              ),
            ),
            const SizedBox(height: 16.0),
            const Text('Você Venceu!', style: TextStyle(fontSize: 22.0, fontWeight: FontWeight.bold, color: Colors.black)),
          ],
        ),
